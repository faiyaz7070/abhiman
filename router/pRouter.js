...
PRouter.post("/createPolls/:userID", async (req, res) => {
  try {
...
PRouter.get('/getAllPolls', async (req, res) => {
  try {
...
PRouter.put('/updatePolls/:pollId', async (req, res) => {
  try {
...
PRouter.get('/polls/user/:userId', async (req, res) => {
  try {
...
PRouter.post('/polls/submit/:userId', async (req, res) => {
  try {
...
PRouter.get('/polls/:pollId/analytics', async (req, res) => {
  try {
    const { pollId } = req.params;
